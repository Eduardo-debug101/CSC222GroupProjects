...
public class MenuInfo {
    ...
    public void loadPresetData(ArrayList<Customer> custList, Reservation[][] reservList) {
        ...
        int num1Letter = rowNum(resv1.getSeat());

        int num2 = columnNum(resv2.getSeat());
        int num2Letter = rowNum(resv2.getSeat());

        int num3 = columnNum(resv3.getSeat());
        int num3Letter = rowNum(resv3.getSeat());

        int num4 = columnNum(resv4.getSeat());
        int num4Letter = rowNum(resv4.getSeat());

        int num5 = columnNum(resv5.getSeat());
        int num5Letter = rowNum(resv5.getSeat());
        ...
        reservList[num1][num1Letter] = resv1;
        reservList[num2][num2Letter] = resv2;
        reservList[num3][num3Letter] = resv3;
        reservList[num4][num4Letter] = resv4;
        reservList[num5][num5Letter] = resv5;
    }
    ...
    public ArrayList<Customer> loadData() {
        ...
        // Changed cust.get(cust.size() - 1).getId() to custFav.getID() as a new ID is created for that customer when it is initialized - BW
